        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <form role="form" action="?actn=user&page=edit&id=<?php echo $_GET['id']?>" method="post">

                                    <div class="form-group">
                                        <label>Name</label>
                                        <input required class="form-control" name="fname" maxlength="30" value="<?php echo $fname?>">
                                        <p class="help-block">Enter Full Name</p>
                                    </div>
                                    <div class="form-group">
                                        <label>Username</label>
                                        <input type="hidden" name="oname" value="<?php echo $oname?>">
                                        <input required class="form-control" name="uname" maxlength="20" value="<?php echo $uname?>">
                                        <p class="help-block">Max of 30 alpha numeric characters.</p>
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input type="hidden" name="opwd" value="<?php echo $opwd?>">
                                        <input required type="password" class="form-control" maxlength="24" id="upwd" name="upwd" value="<?php echo $upwd?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="password" class="form-control" maxlength="24" id="upwd2" name="upwd2"  value="<?php echo $upwd2?>">
