        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Discount Percent</h1>
                </div>
                <!-- /.col-lg-12 -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="text-muted">Top Cases</h4>
                            <?php
                                
                                
                                $que = "SELECT * FROM tbl_disc where CLOSED = 0 ".$que_reg.$que_dis.$que_str.$que_rule." order by DISC desc limit 10";
                                            ...
                                            <?php
                                                ...
                                                if($totcount > 0 and !isset($err))
                                                {
                                                    ...
                                                    foreach($set->con->query($que) as $rs)
                                                    {
                                                        ...
                                                        $link = "'feedback.php?page=disc&id=".$rs['ID']."'";
